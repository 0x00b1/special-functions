...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "cxx23-deprecated-fix"
  WORKING_DIRECTORY "/Users/goodmaa3/com/github/0x00b1/special-functions/build/_deps/rapidcheck-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "cxx23-deprecated-fix")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("cxx23-deprecated-fix" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: cxx23-deprecated-fix")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/cxx23-deprecated-fix")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"cxx23-deprecated-fix\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/goodmaa3/com/github/0x00b1/special-functions/build/_deps/rapidcheck-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/goodmaa3/com/github/0x00b1/special-functions/build/_deps/rapidcheck-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
