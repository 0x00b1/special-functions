...
#include <../include/special_functions/incomplete_elliptic_integral_e.h>
...
RC_GTEST_PROP(incomplete_elliptic_integral_e_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for incomplete_elliptic_integral_e
