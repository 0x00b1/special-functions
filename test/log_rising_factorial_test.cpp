...
#include <../include/special_functions/log_rising_factorial.h>
...
RC_GTEST_PROP(log_rising_factorial_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for log_rising_factorial
