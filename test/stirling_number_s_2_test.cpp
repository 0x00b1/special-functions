...
#include <../include/special_functions/stirling_number_s_2.h>
...
RC_GTEST_PROP(stirling_number_s_2_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for stirling_number_s_2
