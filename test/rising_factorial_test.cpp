...
#include <../include/special_functions/rising_factorial.h>
...
RC_GTEST_PROP(rising_factorial_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for rising_factorial
