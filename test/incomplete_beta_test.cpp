...
#include <../include/special_functions/incomplete_beta.h>
...
RC_GTEST_PROP(incomplete_beta_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for incomplete_beta
