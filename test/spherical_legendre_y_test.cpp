...
#include <../include/special_functions/spherical_legendre_y.h>
...
RC_GTEST_PROP(spherical_legendre_y_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for spherical_legendre_y
