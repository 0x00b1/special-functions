...
#include <../include/special_functions/fresnel_sine_integral_s.h>
...
RC_GTEST_PROP(fresnel_sine_integral_s_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for fresnel_sine_integral_s
