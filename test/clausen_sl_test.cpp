...
RC_GTEST_PROP(clausen_sl_test, mathematical_properties, (double x)) {
    ...
    // 3. TODO: Add specific mathematical properties for clausen_sl:
    ...
    // RC_ASSERT(special_functions::clausen_sl(0.0) == expected_value_at_zero);
    // RC_ASSERT(special_functions::clausen_sl(-x) == special_functions::clausen_sl(x)); // for even functions
    // RC_ASSERT(special_functions::clausen_sl(-x) == -special_functions::clausen_sl(x)); // for odd functions
}
