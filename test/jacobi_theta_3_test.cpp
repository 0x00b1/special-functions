...
#include <../include/special_functions/jacobi_theta_3.h>
...
RC_GTEST_PROP(jacobi_theta_3_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for jacobi_theta_3
