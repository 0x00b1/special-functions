...
#include <../include/special_functions/exp_modified_bessel_i.h>
...
RC_GTEST_PROP(exp_modified_bessel_i_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for exp_modified_bessel_i
