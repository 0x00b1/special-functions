...
RC_GTEST_PROP(clausen_cl_test, mathematical_properties, (double x)) {
    ...
    // 3. TODO: Add specific mathematical properties for clausen_cl:
    ...
    // RC_ASSERT(special_functions::clausen_cl(0.0) == expected_value_at_zero);
    // RC_ASSERT(special_functions::clausen_cl(-x) == special_functions::clausen_cl(x)); // for even functions
    // RC_ASSERT(special_functions::clausen_cl(-x) == -special_functions::clausen_cl(x)); // for odd functions
}
