...
#include <../include/special_functions/bulirsch_elliptic_integral_el1.h>
...
RC_GTEST_PROP(bulirsch_elliptic_integral_el1_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for bulirsch_elliptic_integral_el1
