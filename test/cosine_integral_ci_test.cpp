...
#include <../include/special_functions/cosine_integral_ci.h>
...
RC_GTEST_PROP(cosine_integral_ci_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for cosine_integral_ci
