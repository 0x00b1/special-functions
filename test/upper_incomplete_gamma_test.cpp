...
#include <../include/special_functions/upper_incomplete_gamma.h>
...
RC_GTEST_PROP(upper_incomplete_gamma_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for upper_incomplete_gamma
