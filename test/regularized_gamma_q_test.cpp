...
#include <../include/special_functions/regularized_gamma_q.h>
...
RC_GTEST_PROP(regularized_gamma_q_test, property_based_test, 
              (double x)) {
    // Property-based test using RapidCheck
    // TODO: Add mathematical property tests for regularized_gamma_q
