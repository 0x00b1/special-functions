#ifndef SPECIAL_FUNCTIONS_MATH_CONSTANTS_H
#define SPECIAL_FUNCTIONS_MATH_CONSTANTS_H
...
namespace special_functions {
    ...
    template<typename Tp>
    constexpr Tp
            deg_v = Tp{180} / std::numbers::pi_v<Tp>;

    // Constant: degree to radians conversion.
    template<typename Tp>
    constexpr Tp
            rad_v = std::numbers::pi_v<Tp> / Tp{180};
...
#endif // SPECIAL_FUNCTIONS_MATH_CONSTANTS_H
